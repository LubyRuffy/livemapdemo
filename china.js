...
(function(window) {
    ...
    */
                ...
                for (var cityKey in city.counts[country]) {
                    ...
                    for (var service in counts) {
                        ...
                        links.push({
                            ...
                            source: source,
                            target: target,
                            width: lineScale(counts[service]),
                            color: color
                        });
                    }
                }
                ...
                for (var sourceCity in this._links[sourceCountry]) {
                    ...
                    for (var targetCountry in s.counts) {
                        for (var targetCity in s.counts[targetCountry]) {
                            ...
                            for (var targetservice in s.counts[targetCountry][targetCity]) {
                                var c = s.counts[targetCountry][targetCity][targetservice];
    ...
    queue()
     ...
     var rateById = d3.map();
    function makeMap(error, counties, states, countryCodes) {
